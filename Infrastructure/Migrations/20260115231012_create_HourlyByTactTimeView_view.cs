...
{
    /// <inheritdoc />
    public partial class create_HourlyByTactTimeView_view : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql("""
                                 CREATE OR REPLACE VIEW "HourlyByTactTimeView" AS
                                 SELECT hbt."Id",
        ...
        {
            migrationBuilder.Sql("""
                                 DROP VIEW IF EXISTS "HourlyByTactTimeView";
                                 """);
        }
    }
}

...
public static class CustomIdentityApiEndpointRouteBuilderExtensions
{
        ...
        where TUser : class, new()
    {
        ...
        routeGroup.MapPost("/register", async Task<Results<Ok, ValidationProblem>>
            ([FromBody] DTO.Requests.RegisterRequest registration, HttpContext context, [FromServices] IServiceProvider sp) =>
        {
        ...
        {
            var signInManager = sp.GetRequiredService<CustomSignInManager>();

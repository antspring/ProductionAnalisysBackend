...
namespace Application.DTO.Responses.HourlyByPower;

public class HourlyByPowerResponse
{
    ...
    public HourlyByPowerResponse(HourlyByPowerView hourlyByTactTimeView)
    {
        ...
        Power = hourlyByTactTimeView.Power;
